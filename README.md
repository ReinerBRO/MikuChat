...
### � 音乐工作台
- **Bilibili 音乐搜索**：直接搜索 Bilibili 上的音乐视频，自动关联"初音未来"关键词，发现更多 Miku 歌曲。
- **本地音乐管理**：支持播放本地音乐文件（mp3, wav, ogg, mp4, m4a, flac），自动识别同名封面图片。
- **便捷上传**：通过网页直接上传音乐和封面，系统自动处理关联。
- **黑胶唱片动效**：播放时黑胶唱片优雅旋转，带来沉浸式听歌体验。

![Music Station](./music.png)
