...
class NewsService:
    def __init__(self):
        ...
        self.categories = {
            "周边商品": ["手办", "周边", "预售", "发售", "特典", "フィギュア", "グッズ", "販売", "通販", "受注"],
            "演唱会/活动": ["演唱会", "live", "magical mirai", "雪miku", "活动", "展会", "イベント", "開催", "マジカルミライ", "雪ミク", "ステージ"],
            "游戏更新": ["project diva", "project sekai", "更新", "联动", "コラボ", "アップデート", "プロセカ", "セカイ"],
            "新曲发布": ["新曲", "新歌", "投稿", "殿堂", "配信", "初音ミク公式YouTube", "MV", "楽曲"],
            "社区动态": ["粉丝", "同人", "创作", "感谢", "アンケート", "募集", "キャンペーン"]
        }
